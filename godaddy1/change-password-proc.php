		...
		if($repass == $newpass)
		{
			...
			if(!empty($tot))
			{
				...
				//	header('location:sign-in.php?msg=Password has Changed successfully. Please Sign In again.');
					echo "<script>window.location.href='sign-in.php?msg=Password has Changed successfully. Please Sign In again.'</script>";
				}
				else
				//	header('location:my-account.php?msg=You have entered wrong current Password.&typeid=5');
					echo "<script>window.location.href='my-account.php?msg=You have entered wrong current Password.&typeid=5'</script>";
			}
			else
				//header('location:my-account.php?msg=You are not registred.&typeid=5');
				echo "<script>window.location.href='my-account.php?msg=You are not registred.&typeid=5'</script>";
		}
		else
		//	header('location:my-account.php?msg=New Password and Retyped Password must be same.&typeid=5');
				echo "<script>window.location.href='my-account.php?msg=New Password and Retyped Password must be same.&typeid=5'</script>";
	}
