...
if (!empty($_POST))
{
	...
	if($storename!="")
	{
		$storename= getStoreNameById($storename);
	}
	...
	$dateSlot= (isset($_POST["dateSlot"]) && $_POST["dateSlot"] != "") ? $_POST["dateSlot"] : '';
	$timeSlot=(isset($_POST["timeSlot"]) && $_POST["timeSlot"] != "") ? $_POST["timeSlot"] : '';
	$deliveryslots=$dateSlot." ".$timeSlot;
	...
	echo "<script>window.location.href='my-account.php?msg=An Order has been Placed successfully.&typeid=2';</script>";
}

?>
<script>
//window.location.href='my-account.php?msg=An Order has been Placed successfully.&typeid=2';
</script>