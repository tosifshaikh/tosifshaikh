    ...
    <body >
        <div class="container">
            <div class="alert alert-success alert-dismissible" id="alertDiv">
                <button type="button" class="close" data-dismiss="alert" onclick="toggleClose()">×</button>
                <span id="msg"></span>
              </div>
            ...
            <div class="row">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="1" name = hobbies[]>
                    <label class="form-check-label" for="cricket">
                      Cricket
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="2" name = hobbies[]>
                    <label class="form-check-label" for="football">
                     Football
                    </label>
                  </div>  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="3" name = hobbies[]>
            ...
            <div class="row">
                <div class="col-4">
                    <label class="form-check-label" for="bdate">Birthdate</label>
                    <input type="text" id="datepicker" name="bdate" class="form-control" >
                </div></div>
                <div class="row">
                    <div class="col-4">
...
<script>
    ...
    function submitForm(){
        ...
        success: function (data) {
            ...
            $('#msg').html('<strong>Success!</strong> Data Added Successfully!');
            render(data);
        },
        error: function (data) {
