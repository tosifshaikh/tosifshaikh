...
const Mt = ref(0), J = ref(1), C = ref({}), te = ref(0), zt = ref({}), tt = {}, ge = typeof window > "u";
function po(e, t, r) {
...
function go(e, t) {
  ...
  if (H((h2 = e.data) == null ? void 0 : h2.splade) || console.error("The response is not a Splade response. Did you use the Splade Middleware on this route?"), e.data.splade.lazy || e.data.splade.rehydrate)
    return;
...
const Oi = ref({}), $i = (e) => Oi.value[e], bo = (e) => Object.keys($i.value[e]).length > 0, Ei = ref({}), wo = (e) => Ei.value[e], Ti = ref({}), So = (e) => Ti.value[e], rt = ref([]);
function Oo(e) {
  rt.value.push(e);
}
...
`)].join(`
`));
      let d = Ri((a = h2.props) != null ? a : {}, l), p = cloneVNode(h2, d);
      for (let f in d)
  ...
  return onMounted(() => s.value = true), onUnmounted(() => s.value = false), onMounted(() => {
    watch([t, r, n], (a, o) => {
      ...
      !l || au(() => {
        ...
        h2 ? Ze(h2) : kt(l, xe.First | xe.NoScroll) === Vi.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), i.value = (c = e.value) == null ? void 0 : c.activeElement;
      });
...
let Xi = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
  let n = ref(null), i = computed(() => lt(n)), s = du(), a = inject(Ki, null), o = ref(s === true || a == null ? fu(n.value) : a.resolveTarget());
  return watchEffect(() => {
...
} }), Ki = Symbol("PortalGroupContext"), pu = defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
...
let qt = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", en = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: qt }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Xe()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  }, computed(() => p.value === 0 && !g.value)), Hi((s = d.value) == null ? void 0 : s.defaultView, "keydown", (y) => {
...
let tn = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Xe()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
...
let Zi = jt.RenderStrategy, ut = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  i({ el: s, $el: s });
  let { show: l, appear: u } = qu(), { register: c, unregister: h$1 } = Cu(), m = { value: true }, d = Xe(), p = { value: false }, f = Ji(() => {
  ...
  return onMounted(() => {
    ...
    let { appear: $, show: T, enter: x, enterFrom: _, enterTo: D, entered: B, leave: Se, leaveFrom: Oe, leaveTo: M, ...j } = e, Ke = { ref: s }, fe = { ...j, ...u && l && Et.isServer ? { class: normalizeClass([j.class, ...g, ...S]) } : {} };
  ...
  let a = ref(s.value ? "visible" : "hidden"), o = Ji(() => {
    a.value = "hidden";
  ...
  return onMounted(() => {
    ...
    return z({ ourProps: { ...h$1, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h(Fu, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...h$1, ...c }, n.default)] }, attrs: {}, features: Zi, visible: a.value === "visible", name: "Transition" });
  };
} });
const Lu = {
  props: {
...
function Zt(e, t, r) {
  ...
  t = Tr(t) || 0, H(r) && (c = !!r.leading, h2 = "maxWait" in r, s = h2 ? Qu(Tr(r.maxWait) || 0, t) : s, m = "trailing" in r ? !!r.trailing : m);
  function d(y) {
    var O = n, $ = i;
...
function it(e, t, r) {
  ...
  var a = He(e) ? Q(e) : window, o = a.visualViewport, l = !is() && r, u = (n.left + (l && o ? o.offsetLeft : 0)) / i, c = (n.top + (l && o ? o.offsetTop : 0)) / s, h2 = n.width / i, m = n.height / s;
  return {
    width: h2,
    height: m,
    top: c,
...
function Qc(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? false : a, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, h2 = r.padding, m = r.tether, d = m === void 0 ? true : m, p = r.tetherOffset, f = p === void 0 ? 0 : p, g = un(t, {
    boundary: l,
    rootBoundary: u,
    padding: h2,
    altBoundary: c
...
function td(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = r.boundary, s = r.rootBoundary, a = r.padding, o = r.flipVariations, l = r.allowedAutoPlacements, u = l === void 0 ? uc : l, c = at(n), h2 = c ? o ? Rn : Rn.filter(function(p) {
    return at(p) === c;
...
function nd(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, h2 = r.rootBoundary, m = r.altBoundary, d = r.flipVariations, p = d === void 0 ? true : d, f = r.allowedAutoPlacements, g = t.options.placement, S = he(g), I = S === g, A = l || (I || !p ? [Bt(g)] : rd(g)), w = [g].concat(A).reduce(function(Ye, $e) {
...
function fs(e, t, r, n, i, s) {
  ...
  if (u && c)
    return u == t && c == e;
  var h2 = -1, m = true, d = r & Ed ? new Ut() : void 0;
...
function ff(e, t, r, n, i, s) {
  ...
  if (!(r & cf)) {
    var d = c && ii.call(e, "__wrapped__"), p = h2 && ii.call(t, "__wrapped__");
    if (d || p) {
...
function mf(e, t, r, n) {
  ...
  for (; ++i < s; ) {
    ...
    if (a && o[2]) {
      ...
      if (!(m === void 0 ? ir(c, u, pf | hf, n, h2) : m))
        return false;
    }
  }
  return true;
...
function ip(e, t, r, n, i, s) {
  return openBlock(), createElementBlock("div", np, [
...
function vp(e, t, r, n, i, s) {
  return openBlock(), createElementBlock("div", mp, [
    renderSlot(e.$slots, "default")
  ], 512);
}
