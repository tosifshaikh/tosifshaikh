...
function getControls()
{
	...
	if(count($controlPrivArr)>0 || $_SESSION['UserLevel']==0){
		...
		if(isset($controlPrivArr[2]) || $_SESSION['UserLevel']==0){
       	    $controlStr.='<li style="cursor:pointer; text-align:left;"><a onClick="openWorkStatuslist();"><strong>&raquo; Manage Work Status List </strong></a></li> ';
    	}
		if(isset($controlPrivArr[3]) || $_SESSION['UserLevel']==0){
    	   $controlStr.='<li style="cursor:pointer; text-align:left;"><a onClick="openEmailTemplate();"><strong>&raquo; Email Template </strong></a></li> ';
    	}		
		if(isset($controlPrivArr[1]) || $_SESSION['UserLevel']==0){
    	   $controlStr.='<li style="cursor:pointer; text-align:left; "><a onClick="openStatuslist();"><strong>&raquo; Manage Status List </strong></a></li>';
    	}    	
