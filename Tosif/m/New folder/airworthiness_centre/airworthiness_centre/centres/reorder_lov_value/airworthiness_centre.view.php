<?php
$clId = (isset($_REQUEST["client_id"]) && $_REQUEST["client_id"]!='')?$_REQUEST["client_id"]:0;
...
<body onload="loadGrid();" onunload="loadparentWin();">
...
<tr>
  <td height="100%" class="whiteborderthree" align="center" valign="top" id="PageContent">
    ...
    <tr>
      ...
      <input type="hidden" id="client_id" name="client_id" value="<?php echo $clId; ?>">
