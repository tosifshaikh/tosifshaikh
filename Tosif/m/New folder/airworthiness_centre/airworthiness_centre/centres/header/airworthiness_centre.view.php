                ...
                <input type="hidden" id="mainRowid" name="mainRowid" value="">
                  ...
                  <table border="0" align="left" cellpadding="3" cellspacing="1" >
                    <tr>
                      ...
                      ?>
                      <select <?php echo $addStr; ?> id="clientVal" name="clientVal"  onchange="loadGrid();">
                          <?php 
                      ...
                      <td><select disabled="disabled" name="filter_type" id="filter_type" onchange="showTextBox(this.value);"  >
                          ...
                          <?php if(!isset($_REQUEST['comp_main_id']) && !isset($_REQUEST['template_id'])) { ?>
                          <option value="4">Reference Type</option>
                          <?php } ?>
                          <option value="5">ARC Sequencing</option>
                        </select></td>
                      <td align="left" nowrap="nowrap" id="tdReadOnly" style="display:none;"><strong>Select Read Only:</strong>
                      <select disabled="disabled" id="read_only" name="read_only" class="selectauto">
