...
dategroupID = '<?php echo (isset($_REQUEST['dateGroupId']) && $_REQUEST['dateGroupId']!="")?$_REQUEST['dateGroupId']:0; ?>';
</script>
...
<script>
dategroupID = '<?php echo (isset($_REQUEST['dateGroupId']) && $_REQUEST['dateGroupId']!="")?$_REQUEST['dateGroupId']:0; ?>';
docType = '<?php echo (isset($_REQUEST['docType']) && $_REQUEST['docType']!="")?$_REQUEST['docType']:0; ?>';
</script>
