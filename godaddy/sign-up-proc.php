...
if(trim($Name) == "" || trim($Email) == "" || trim($Zipcode) == ""){
	...
	header('location:sign-up.php');
		...
		else
		{
			...
			$link= $WebLocation."activate-your-account.php?t=".$stringToEncrypt;
			...
			$body .= "<tr><td style='height:30px;'>However your account is disable. To enable your account please <a href='".$link."'>Click Here</a>.<br/><br/>OR<br/><br/>Copy and Paste below link in your browser addressbar<br/><br/>".$link."</td></tr>";
