...
$Name="";$Email="";$Zipcode="";$Error="";
if(isset($_SESSION["Error"]))
{
	$Name=(isset($_SESSION["Name"]) && $_SESSION["Name"] != "") ? $_SESSION["Name"] : '';
	$Email=(isset($_SESSION["Email"]) && $_SESSION["Email"] != "") ? $_SESSION["Email"] : '';
	$Zipcode=(isset($_SESSION["Zipcode"]) && $_SESSION["Zipcode"] != "") ? $_SESSION["Zipcode"] : '';
	$Error=(isset($_SESSION["Error"]) && $_SESSION["Error"] != "") ? '<p><strongg>'. $_SESSION["Error"] . '</strongg></p>' : '';
                      ...
                      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
                        <div id="navbar" class="navbar-collapse collapse">
                          <ul class="nav navbar-nav">
                            ...
                            <li class="active dropdown"><a href="#" style="padding-right:0px;">SIGN UP</a></li>
                          </ul>
                        </div>
                    </div>
                  </div>
      ...
      <div class="row ma5-page"> <a class="ma5-toggle-menu cd-nav-trigger hidden-sm hidden-md hidden-lg " href="#!"><span class="cd-nav-icon"></span> <svg x="0px" y="0px" width="54px" height="54px" viewBox="0 0 54 54"><circle fill="transparent" stroke="#656e79" stroke-width="1" cx="27" cy="27" r="25" stroke-dasharray="157 157" stroke-dashoffset="157"></circle></svg> Navigation </a>
        <div class="ma5-menu-mobile"> 
          ...
          <ul class="  ma5-ul">
            ...
            <li class="ma5-li-2"><a href="#">SIGN UP</a></li>
          </ul>
        </div>
      </div>  
	</div>  
...
<div id="inrcontent1">
  <div class="container">
  	<div class="row">
      <div class="col-sm-12">
      	  <h2>Let's get started with your<br>membership!</h2>
      </div>       
    </div>
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-8 col-md-6">           
      	<div class="teaser">
        	<div>     
				<?php echo $Error; ?>
            	<form method="post" action="sign-up-proc.php">
                    <input type="text" class="form-control" required id="Name" name="Name" placeholder="Your Full Name" aria-label="Enter your Full Name" title="Enter your Full Name" value="<?php echo $Name; ?>" />                
                    <input type="text" class="form-control" required id="Email" name="Email" placeholder="Email Address" aria-label="Enter your Email Address" title="Enter your Email Address" value="<?php echo $Email; ?>" />
                    <input type="tel" class="form-control" required id="Zipcode" name="Zipcode" placeholder="Zip Code" aria-label="Enter your Zip Code" title="Enter your Zip Code" value="<?php echo $Zipcode; ?>" />                    
                    <button type="submit" class="button" value="Submit"><span>Submit</span></button>                	
                </form>    	           
                <p>Already have an account? <br class="visible-xs"/><a href="sign-in.php">Click here to sign in</a></p>
            </div>
        </div>
      </div> 
      <div class="hidden-xs col-sm-2 col-md-3">&nbsp;</div>     
