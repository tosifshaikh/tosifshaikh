...
function loadCategories() {
  return (0,_http_service__WEBPACK_IMPORTED_MODULE_0__.httpFile)().get('/categories');
}
function deleteCategory(id) {
  return (0,_http_service__WEBPACK_IMPORTED_MODULE_0__.httpFile)()["delete"]("/categories/".concat(id));
}
