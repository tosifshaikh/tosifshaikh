            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Reset Password
                            Request</h3></div>
                        <div class="card-body">
                            ...
                            <form v-on:submit.prevent="onSubmit">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="email" type="email"
                                           placeholder="name@example.com" v-model="user.email" autofocus="autofocus"/>
                                    <label for="email">Email address</label>
                                    <div class="invalid-feedback" v-if="errors.email">{{ errors.email[0] }}</div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                    <router-link to="/login" class="btn btn-primary">Login</router-link>
                                    <button type="submit" class="btn btn-primary" ref="btnSubmit">Request Password
                                    </button>
